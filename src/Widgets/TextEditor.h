...
#define _XKEYCHECK_H
#define _ALLOW_KEYWORD_MACROS // Need for Compilation on VS2017 !!!
...
public:
	...
	static const int DebugDataSpace = 20;
	...
	struct LanguageDefinition {
		...
		static const LanguageDefinition& IEC_ST();
		static const LanguageDefinition& TEXT_FILE();
